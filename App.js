...
import AdsInitializer from "./providers/AdsInitializer";
...
function CustomDrawerContent(props) {
  // keep the original filtering logic if you had it in your previous drawer content
  return (
    <DrawerContentScrollView {...props}>
      <DrawerItemList {...props} />
      {/* Add any custom drawer items from your original App.js (ContactUs, About, etc.) */}
      <DrawerItem
        label="About"
      ...
      <AuthProvider>
        <AdsInitializer>
          <NavigationContainer>
            ...
            >
              <DrawerNav.Screen name="SignIn" component={SigninPage} />
              <DrawerNav.Screen name="Register" component={RegisterPage} />
              <DrawerNav.Screen name="Payment" component={PaymentPage} />
              <DrawerNav.Screen name="ProfileStack" component={StackProfilePage} />
              <DrawerNav.Screen name="QuestionStack" component={StackQuestionPage} />
              <DrawerNav.Screen name="QuizStack" component={StackQuizPage} />
              <DrawerNav.Screen name="FlashCardStack" component={FlashCardStack} />
              <DrawerNav.Screen name="About" component={AboutPage} />
              {/* add other screens you had originally */}
            </DrawerNav.Navigator>
          </NavigationContainer>
        </AdsInitializer>
      </AuthProvider>
